...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center">{{ __('Two factor challenge') }}</div>

                <div class="card-body text-center">
                    {{ __('Inserisci il tuo codice di autenticazione login') }}
            ...
            <div class="card">
                <div class="card-header text-center">{{ __('Codice di recupero') }}</div>
                ...
                <div class="card-body text-center">
                    ...
                    <form method="POST" action="{{ route('two-factor.login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="recovery_code" class="col-md-4 col-form-label text-md-end">{{ __('Password') }}</label>
