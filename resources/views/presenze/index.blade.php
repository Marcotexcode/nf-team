                    ...
                    @foreach ($mesiNumero as $meseNumero)
                        @foreach ($anni as $anno)
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-primary  my-2" href="{{route('presenze.index', ["data" => $dataPrecedente])}}"><i class="fas align-middle fa-arrow-left"></i></a>
                                <span class="text-center my-2 mx-5"><h2 class="text-center">{{$mese}} - {{$anno}}</h2></span>
                                <a class="btn btn-primary my-2" href="{{route('presenze.index', ["data" => $dataSuccessiva])}}"><i class="fas align-middle fa-arrow-right"></i></a>
                            </div>
                            <div class="my-3">
