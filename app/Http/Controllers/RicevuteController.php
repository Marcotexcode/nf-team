...
class RicevuteController extends Controller
{
    public function index()
    {
        ...
        return view('stampe.ricevute', compact('collaboratori', 'raccoltaPresenze', 'totale', 'mese', 'anno', 'giorni', 'nomeCollaboratori', 'filtroMese'));
    }
    ...
    {
        $datiFiltro = [
            'filtroMese' => $request->meseAnno,
        ];

        session()->put('filtro', $datiFiltro);
